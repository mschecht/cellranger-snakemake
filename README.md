...
- [Tutorial](https://sc-preprocess.readthedocs.io/en/latest/tutorial.html)
...
> **Important:** After exporting, manually remove the `sc-preprocess` line from the `pip:` section in both files. The package should be installed separately via `pip install -e .`, not pinned in the environment.
